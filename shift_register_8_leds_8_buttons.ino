...
//
// We'll use all 8 pins from 1st SR for LEDs and all 8 pins from
// the 2nd one for buttons.

const int MAX_PIN_INDEX = 15, MAX_LED_INDEX = 7, MAX_BUTTON_INDEX = MAX_PIN_INDEX;
const int ledPins[] = {0, 1, 2, 3, 4, 5, 6, 7};
const int buttonPins[] = {8, 9, 10, 11, 12, 13, 14, 15};
byte dataSR1 = 0, dataSR2 = 0;
...
// individual bits in a number 1 or 0.
{
  ...
  desiredPin = desiredPin - 8 * shiftRegisterIndex;  // 12 --> 12 - 8 * 1 --> 4
  ...
  // This is pecially useful while setting all index states, and
